$(document).ready(function() {
    ...
    $("#delete-selected-users-modal-button").on("click",
        function(e) {
            e.preventDefault();
    ...
    $("#delete-selected-users-button").on("click",
        function(e) {
            e.preventDefault();
    ...
    $("#delete-selected-courses-modal-button").on("click",
        function(e) {
            e.preventDefault();
    ...
    // Delete button in the modal
    $("#delete-selected-courses-button").on("click",
        function(e) {
            e.preventDefault();
    ...
    $(".remove-teacher-from-course").on("click",
        function(e) {
            e.preventDefault();
    ...
    $(".reset-password-button").on("click",
        function() {
            ...
            var sendData = {
                "userId": $(this).closest(".collapsible-header").parent()
                    .find("input[type='checkbox'][name='user-row']").val()
            }
