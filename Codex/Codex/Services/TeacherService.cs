    ...
    public class TeacherService
    {
        ...
        public List<AssignmentViewModel> GetAllAssignmentsInCourse(int courseInstanceId) {
            ...
            foreach (var assignment in assignmentQuery) {
                if (DateTime.Now < assignment.StartTime) {
                    assignmentState = "Upcoming";
                }
                else if (assignment.StartTime < DateTime.Now && DateTime.Now < assignment.EndTime) {
                    assignmentState = "Open";
                }
                else if (assignment.EndTime < DateTime.Now) {
